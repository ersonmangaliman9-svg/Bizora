...
function SplashScreen({ onDone }) {
  ...
  return (
    <div onClick={skip} style={{
      height: 640, background: "radial-gradient(circle at 50% 42%, #0F7A63 0%, #0A5548 55%, #072F28 100%)",
...
export default function Bizora() {
  ...
  if (!loaded) {
    return (
      <div style={{ display: "flex", flexDirection: "column", gap: 12, alignItems: "center", justifyContent: "center", height: 640, background: LIGHT.bg, fontFamily: "'Sora', sans-serif" }}>
