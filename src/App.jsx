...
function SplashScreen({ onDone }) {
  ...
  return (
    <div onClick={skip} className="bz-frame" style={{
      minHeight: "100dvh", width: "100%", maxWidth: 420, margin: "0 auto", boxSizing: "border-box",
...
export default function Bizora() {
  ...
  }, [loaded, theme, notifyLowStock, products, customers, sales, expenses, invoices]);
  ...
  const finishOnboarding = async (biz, greeting) => {
    ...
    } catch (e) { /* profile row may already exist — fine, keep going with local state */ }
  ...
  if (!loaded) {
    return (
      <div className="bz-frame" style={{ display: "flex", flexDirection: "column", gap: 12, alignItems: "center", justifyContent: "center", minHeight: "100dvh", width: "100%", maxWidth: 420, margin: "0 auto", boxSizing: "border-box", overflow: "hidden", background: LIGHT.bg, fontFamily: "'Sora', sans-serif" }}>
  ...
  return (
    <div className="bz-frame" style={{
      ...
      width: "100%", maxWidth: 420, margin: "0 auto", minHeight: "100dvh", position: "relative", boxSizing: "border-box",
      ...
      <div ref={scrollRef} className="bz-scroll" style={{ height: "100dvh", overflowY: "auto", paddingBottom: 88 }}
...
function AuthFlow({ screen, setScreen, theme, authUser, onSignedIn, onSignedUp, onOnboardingDone }) {
  ...
  return (
    <div className="bz-frame" style={{
      ...
      "--danger": colors.danger, "--success": colors.success,
      background: "var(--bg)", color: "var(--text)", fontFamily: "'Inter', sans-serif",
      width: "100%", maxWidth: 420, margin: "0 auto", minHeight: "100dvh", height: "100dvh", position: "relative", boxSizing: "border-box",
      overflow: "hidden", boxShadow: theme === "dark" ? "0 0 0 1px #1c2622" : "0 0 0 1px #eae6da",
    }}>
      <style>{`
        @import url('https://fonts.googleapis.com/css2?family=Sora:wght@400;600;700;800&family=Inter:wght@400;500;600;700&display=swap');
